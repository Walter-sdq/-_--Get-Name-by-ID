...
const personData = [
    ...
    { name: "Ehizojie Glory", id: "153" },
    { name: "Chidima Oberta", id: "154" },
    { name: "Benita Ebosele", id: "155" },
    { name: "Richard Chukwu", id: "156" },
    { name: "Akemu Rex", id: "157" },
    { name: "Aisaboluokpia Japheth", id: "158" },
    { name: "Raymond Ehis Okosun", id: "159" },
    { name: "Tovia Omoh Williams", id: "160" },
    { name: "Ibe Chinyere Gift", id: "161" },
    { name: "Gabriel Oghor", id: "162" },
    { name: "Christabel Onojasike", id: "163" },
    { name: "Patience Onah The", id: "164" },
    { name: "Patience Imuse", id: "165" },
    { name: "Umoru Osigbemhe", id: "166" },
    { name: "Amanokhai Zainab", id: "167" },
    { name: "Faith Ebosele", id: "168" },
    { name: "Dela Ogbemudia", id: "169" },
    { name: "Mary Abure", id: "170" },
    { name: "Naomi Jatto", id: "171" },
    { name: "Igbinigie Joy", id: "172" },
    { name: "Glory", id: "173" },
    { name: "EBOHON Timothy Uamai", id: "174" },
    { name: "Eniola Omolade", id: "175" },
    { name: "Eniola", id: "176" },
    { name: "John Okey", id: "177" },
    { name: "Oga Timothy", id: "178" },
...
function getAttendantNameByCode(id) {
    ...
    if (person) {
        ...
        return "❌can't find your name SORRY❌ please confirm your code or type in a code";
    }
}
...
fs.writefile('/attended/person.txt', personData.find((person) => person.name),()=> { console.log('add'); })